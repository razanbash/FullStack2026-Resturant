...
//     `select name, email, hashed_password, role from users where id =
//         $1`,
//     [id],
//   );
...
//   const result =
//     await pool.query(`select id, name, email, hashed_password, role from users where email =
//         $1 , [email]`);
//   return result.rows[0];
// };
...
//         email = $2
//         where id = $2 returing id , name ,email
//         `,
//     [name, email, id],
//   );
//   return result.rows[0];
